...
const loginUserAPI = () => {
    const URL_BACKEND = 'https://687e66a6efe65e5200869488.mockapi.io/testuser/1';
    return axios.get(URL_BACKEND);
}

export { createUserAPI, updateUserAPI, deleteUserAPI, FetchAllUserAPI, showUserAPI, registerUserAPI, loginUserAPI }